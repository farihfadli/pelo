...
<!-- Graph CSS -->
<link href="<?php echo base_url(); ?>/assets/back/css/font-awesome.css" rel="stylesheet"> 
<!-- jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/back/css/icon-font.min.css" type='text/css' />
<script src="<?php echo base_url(); ?>/assets/back/js/amcharts.js"></script>	
<script src="<?php echo base_url(); ?>/assets/back/js/serial.js"></script>	
<script src="<?php echo base_url(); ?>/assets/back/js/light.js"></script>	
<!-- //lined-icons -->
<script src="<?php echo base_url(); ?>/assets/back/js/jquery-1.10.2.min.js"></script>
   <!--pie-chart--->
