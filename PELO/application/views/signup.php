...
<body class="align">
    ...
    <div class="grid">
        ...
        <div class="form__field">
          <label for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">No. Handphone</span></label>
          <input id="login__username" type="text" name="nohp" class="form__input" placeholder="No. Handphone" required>
        </div>
        ...
        <div class="form__field">
          <label for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Gender</span></label>
          <input id="user" type="radio" name="jeniskelamin" class="input" value="Male" checked>Male
          <input id="user" type="radio" name="jeniskelamin" class="input" value="Female">Female
        </div>
		...
		<a href="<?php echo base_url() . 'signin' ?>"><button>Back</button></a>
        </div>
