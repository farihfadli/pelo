...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">Order Form</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="<?php echo base_url().'MyController/index1'?>">Home</a><label>/</label>Order Form</h3>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- contact -->
		...
		<div class="container">
			...
			<?php echo form_open_multipart(base_url('MyController/orderr')); ?>
				<form>
						...
						<div class="contact-form2">
							<h4>Pesanan</h4>
							<p>Format : Nama barang-warna-size-jumlah pesanan</p>
								
								<input type="text" name="pesanan" placeholder="" required="">
