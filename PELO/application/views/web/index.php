		...
		<div class="content-head">
					...
					<div class="col-md-6 col-m1 animated wow fadeInLeft" data-wow-delay=".1s">
						...
						<div class="col-md-6 col-2">
							<a href="<?php echo base_url().'MyController/prod'?>"><img src="<?php echo base_url(); ?>/assets/web/images/pi3.jpg" class="img-responsive" alt="">
							</a></div>
							<div class="col-md-6 col-p">
								<h5>The One and Only</h5>
								<p>SUB based new college fashion apparel</p>
								<a href="<?php echo base_url().'MyController/prod'?>" class="shop" data-hover="Shop Now">Shop Now</a>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="col-1">
						<div class="col-md-6 col-p">
								<h5>Detail in Every Parts</h5>
								<p>Serve you a high quality apparel with premium materials and fascinating design</p>
								<a href="<?php echo base_url().'MyController/prod'?>" class="shop" data-hover="Shop Now">Shop Now</a>
							</div>
						<div class="col-md-6 col-2">
							<a href="<?php echo base_url().'MyController/prod'?>"><img src="<?php echo base_url(); ?>/assets/web/images/pi.jpg" class="img-responsive" alt="">
							</a></div>
							<div class="clearfix"> </div>
						</div>
						</div>
							 ...
							 <!-- start content_slider -->
						       <div id="owl-demo" class="owl-carousel">
					                <div class="item">					                	 
											...
											<a href="<?php echo base_url().'MyController/prod'?>" class="shop-2" >Shop Now</a>
